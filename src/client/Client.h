...
class Client {
 public:
  ...
  const Texture &cursorQuest() const { return _cursorQuest; }
 ...
 private:
  ...
  void handle_SV_OBJECT_STARTS_QUESTS(size_t serial,
                                      const std::set<std::string> &&questIDs);
  void handle_SV_OBJECT_ENDS_QUESTS(size_t serial,
                                    const std::set<std::string> &&questIDs);
