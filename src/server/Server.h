...
private:
    ...
    */
    ...
    void handle_CL_LOGIN_EXISTING(const Socket &client, const std::string &name, const std::string &clientVersion);
    void handle_CL_LOGIN_NEW(const Socket &client, const std::string &name, const std::string &classID, std::string &clientVersion);
    ...
    void handle_CL_COMPLETE_QUEST(User &user, const Quest::ID &quest, size_t giverSerial);
};
